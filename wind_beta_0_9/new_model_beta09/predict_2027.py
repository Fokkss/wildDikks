...
def main() -> None:
    ...
    p.add_argument("--output_path", default="submissions_beta09/submission_2027_beta09_production.csv")
    ...
    p.add_argument("--extra_profile", default="physics", choices=["none", "dircloud", "physics", "physics_strong", "physics_plus_dir_tiny", "all_mild", "all_strong", "lowrelax"])
    args = p.parse_args()
