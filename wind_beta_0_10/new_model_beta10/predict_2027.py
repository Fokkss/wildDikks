...
def main() -> None:
    ...
    p.add_argument("--output_path", default="submissions_beta10/submission_2027_beta10_production.csv")
    ...
    p.add_argument("--extra_profile", default="physics", choices=["none", "dircloud", "physics", "physics_strong", "physics_xstrong", "physics_ultra", "physics_plus_dir_tiny", "theory103", "density_boost", "all_mild", "all_strong", "lowrelax"])
    args = p.parse_args()
